...
@st.cache_data
def load_data():
    df = pd.read_excel("Sleep_Efficiency_Cleaned.xlsx")
    return df
...
alcohol_filter = st.sidebar.multiselect("Alcohol Level", df["Alcohol_Level"].unique(), default=df["Alcohol_Level"].unique())
